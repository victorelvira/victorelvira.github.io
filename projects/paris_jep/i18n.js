...
const FR = [
  ...
  ['Entradas en el lugar', 'Billets sur place'], ['Gratuito', 'Gratuit'], ['Participación por verificar', 'Participation à vérifier'], ['Taquilla', 'Billetterie'], ['Apertura excepcional', 'Ouverture exceptionnelle'], ['Inscripciones completas', 'Inscriptions complètes'], ['Completo · sólo invitación', 'Complet · sur invitation'], ['Sin reserva: se entra directamente', 'Sans réservation : entrée directe'], ['Reserva previa obligatoria', 'Réservation obligatoire'], ['Parte libre, ticket in situ o cupo por orden de llegada', 'Accès en partie libre, billet sur place ou dans la limite des places'], ['Mecanismo de acceso todavía no confirmado', 'Mode d’accès pas encore confirmé'], ['Sin confirmar', 'Non confirmé'], ['Mixto', 'Mixte'], ['Ocultar completos', 'Masquer les complets'], ['Sólo fichas con fuente individual o específica (no páginas índice)', 'Seulement les fiches à source individuelle ou spécifique'], ['Sólo fuentes verificadas', 'Sources vérifiées seulement'], ['Vigilar cancelaciones', 'Surveiller les annulations'], ['Disponibilidad no comprobada', 'Disponibilité non vérifiée'], ['Hay plazas', 'Places disponibles'], ['Fuente / programa', 'Source / programme'], ['Programa oficial', 'Programme officiel'], ['No está en el programa oficial: horarios por confirmar.', 'Absent du programme officiel : horaires à confirmer.'], ['Reservar', 'Réserver'], ['Fuente: página índice, no verificada individualmente.', 'Source : page index, non vérifiée individuellement.'], ['Completo', 'Complet'], ['Por verificar', 'À vérifier'],
  ['Día', 'Jour'], ['Cualquiera', 'Tous'], ['Sáb. 19', 'Sam. 19'], ['Dom. 20', 'Dim. 20'], ['Ambos', 'Les deux'],
  ['Lugares con visita el sábado y el domingo', 'Lieux ouverts samedi et dimanche'], ['Sigue abierto', 'Encore ouvert'], ['A partir de la hora actual', 'À partir de l’heure actuelle'], ['Ahora', 'Maintenant'], ['Sáb.', 'Sam.'], ['Dom.', 'Dim.'], ['ahora', 'maintenant'], ['Reserva', 'Réserv.'], ['Sin info', 'Sans info'], ['verificados', 'vérifiées'], ['con completos', 'avec complets'], ['＋ pulsa', '＋ clic'], ['− cerrar', '− fermer'], ['sin filtros', 'sans filtres'], ['Lugares con visita a esa hora o más tarde.', 'Lieux avec une visite à cette heure ou plus tard.'], ['Elige una hora para ver lo que sigue abierto.', 'Choisissez une heure pour voir ce qui reste ouvert.'], ['Incluir horarios sin confirmar', 'Inclure les horaires non confirmés'], ['otros proyectos interactivos', 'autres projets interactifs'], ['Versión y última actualización', 'Version et dernière mise à jour'], ['Desde', 'De'], ['Hasta', 'À'],
  ...
  ['Mostrar todos los lugares filtrados', 'Afficher tous les lieux filtrés'], ['Me interesa', 'Ça m’intéresse'], ['Descartar', 'Écarter'], ['Ocultar descartados ✕', 'Masquer les écartés ✕'], ['Esconder los lugares marcados con ✕', 'Masquer les lieux marqués ✕'], ['Sólo favoritos ♥', 'Favoris ♥ seulement'], ['Ver sólo los lugares marcados con ♥', 'Voir seulement les lieux marqués ♥'], ['♥ sólo', '♥ seuls'], ['con ✕', 'avec ✕'], ['Ver todos', 'Voir tout'], ['📍 Dónde estoy', '📍 Où je suis'], ['📍 Siguiendo', '📍 Suivi activé'], ['📍 Volver a mí', '📍 Revenir à moi'], ['📍 Localizando…', '📍 Localisation…'], ['📍 Permiso denegado', '📍 Permission refusée'], ['📍 No disponible', '📍 Indisponible'], ['Estás aquí', 'Vous êtes ici'], ['Mostrar un punto en tu posición', 'Afficher un point à votre position'], ['Te está siguiendo. Pulsa para apagarlo', 'Il vous suit. Appuyez pour l’arrêter'], ['Llevar el mapa de vuelta a ti', 'Ramener la carte sur vous'],
...
const RX = [[/(\d+) activos · (\d+) lugares/g, '$1 actifs · $2 lieux'], [/(\d+) de (\d+) · /g, '$1 sur $2 · '],
  [/ en el mapa/g, ' sur la carte'], [/ con ubicación pendiente/g, ' sans emplacement'], [/(\d+) lugares con horario sin confirmar quedan fuera\./g, '$1 lieux aux horaires non confirmés sont exclus.'], [/\blugares\b/g, 'lieux'], [/Desde /g, 'Dès '], [/Hasta /g, "Jusqu'à "]];
const tr = s => { let t = s; for (const [a, b] of FR) if (t.includes(a)) t = t.split(a).join(b); for (const [r, b] of RX) t = t.replace(r, b); return t; };
function walk(root) {
  // A node already detached from the document (React-less re-renders drop text nodes) has no parent: skip it.
